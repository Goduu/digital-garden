...
// import { fullName, sortedAchievements, sortedProfessionalExperiences } from '../../helpers/utils'
...
//   header: {
//     backgroundColor: theme === Theme.Dark ? getNeutralColor(2, theme) : getAccentColor(9, theme),
//     color: contrastColor,
...
// const PDF: FC<PDFProps> = ({ privateInformation }) => {
...
//                       {Array.from(Array(allSkills.length - skillIndex)).map((star, starIndex) => (
...
//                 <View style={styles.itemHeading}>
//                   <Text style={styles.professionalTitle}>{professionalExperience.title}</Text>
...
//                     {professionalExperience.endDate ? professionalExperience.endDate : 'Current'}
//                   </Text>
//                 </View>
...
//                   <Text style={styles.itemSubheading}>{achievement.organization}</Text>
//                 </View>
